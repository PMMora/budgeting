...
from db.models.transaction import Transaction, TransactionObj
...
class BudgetAPI:
    ...
    def add_transaction(self, 
        ...
        # Create TransactionObj and use it
        transaction_obj = TransactionObj(
            type=tx_type,
            amount=amount,
            category_name=category,  # Use category_name instead of category_id
            vendor=vendor,
            note=note,
            transaction_date=parsed_date
        )
        
        return self.transaction_manager.add_transaction(transaction_obj)
    
    def add_transaction_obj(self, transaction_obj: TransactionObj) -> Transaction:
        """Add a transaction directly from TransactionObj"""
        return self.transaction_manager.add_transaction(transaction_obj)
